...
public class SettingsPage extends Activity {
    protected void onCreate(Bundle savedInstanceState){
        ...
        settingsButton3.setBackgroundColor(Color.rgb(33, 150, 243));
        ...
        confirmButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.currentUserObj.updateUsername(newUsername);
            }
        });
        ...
        confirmButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.currentUserObj.updatePassword(newPassword);
            }
        });
    }
}
